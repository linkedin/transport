 ...
 * output type. All types (both input and output types) must extend the {@link com.linkedin.stdudfs.api.data.StdData}
 * interface.
 */
public abstract class StdUDF {
   ...
   * {@link com.linkedin.stdudfs.api.data.StdData} and {@link com.linkedin.stdudfs.api.types.StdType} objects
   */
  ...
  /**
   * Returns a {@link StdFactory} object which can be used to create {@link com.linkedin.stdudfs.api.data.StdData} and
   * {@link com.linkedin.stdudfs.api.types.StdType} objects
   */
