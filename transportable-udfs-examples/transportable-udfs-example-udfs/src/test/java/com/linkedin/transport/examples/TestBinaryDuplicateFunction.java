...
public class TestBinaryDuplicateFunction extends AbstractUDFTest {
  @Override
  ...
  private void testBinaryDuplicateStringHelper(Tester tester, String input, String expectedOutput) {
  ...
  private void testBinaryDuplicateHelper(Tester tester, byte[] input, byte[] expectedOutput) {
