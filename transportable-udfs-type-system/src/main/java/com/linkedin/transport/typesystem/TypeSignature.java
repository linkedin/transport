...
public class TypeSignature {
  ...
  protected TypeSignature(TypeSignatureElement base, List<TypeSignature> parameters, List<String> parameterNames) {
    ...
    if (parameterNames != null) {
      if (!base.equals(ConcreteTypeSignatureElement.STRUCT)) {
  ...
  private static TypeSignatureElement getTypeSignatureElement(String currentBase) {
    ...
    if (validId(currentBase)) {
      switch (currentBase.toLowerCase()) {
        case "boolean":
          currentBaseElement = ConcreteTypeSignatureElement.BOOLEAN;
          break;
        case "integer":
          currentBaseElement = ConcreteTypeSignatureElement.INTEGER;
          break;
        case "bigint":
          currentBaseElement = ConcreteTypeSignatureElement.LONG;
          break;
        case "varchar":
        ...
        case "array":
          ...
          break;
        case "map":
          currentBaseElement = ConcreteTypeSignatureElement.MAP;
          break;
        case "row":
          currentBaseElement = ConcreteTypeSignatureElement.STRUCT;
          break;
        default:
