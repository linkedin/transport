...
public abstract class UDF3<I1, I2, I3, O>
    extends UDF {
   ...
   */
  public abstract O eval(I1 arg1, I2 arg2, I3 arg3);
   ...
   * given to the UDF as opposed to non-constant arguments that are expressions which depend on columns. For example, in
   * the query {@code SELECT my_udf('my_value', T.Col1) FROM T}, {@literal my_value} is a constant argument to the UDF
   * and its value is the same for all invocations of this UDF, while {@code T.Col1} is a non-constant argument since it
   * is an expression that depends on a table column, and hence its value changes on a per-row basis).
   *
   ...
   */
  public String[] getRequiredFiles(I1 arg1, I2 arg2, I3 arg3) {
    return new String[]{};
  }
