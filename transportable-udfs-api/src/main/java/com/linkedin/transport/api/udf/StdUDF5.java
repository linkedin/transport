...
public abstract class StdUDF5<I1 extends StdData, I2 extends StdData, I3 extends StdData, I4 extends StdData,
    I5 extends StdData, O extends StdData> extends StdUDF {
   ...
   */
  public abstract O eval(I1 arg1, I2 arg2, I3 arg3, I4 arg4, I5 arg5);
   ...
   * <p>
   * The arguments passed to {@link #eval(StdData, StdData, StdData, StdData, StdData)} are passed to this method as
   * well to allow users to construct required file paths from arguments passed to the UDF. Since this method is called
   * before any rows are processed, only constant UDF arguments should be used to construct the file paths. Values of
   ...
   */
  public String[] getRequiredFiles(I1 arg1, I2 arg2, I3 arg3, I4 arg4, I5 arg5) {
    return new String[]{};
  }
