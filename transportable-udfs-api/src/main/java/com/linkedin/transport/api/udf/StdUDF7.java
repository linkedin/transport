...
public abstract class StdUDF7<I1, I2, I3, I4,
    I5, I6, I7, O> extends StdUDF {
   ...
   */
  public abstract O eval(I1 arg1, I2 arg2, I3 arg3, I4 arg4, I5 arg5, I6 arg6, I7 arg7);
   ...
   * The arguments passed to {@link #eval(Object,Object,Object,Object,Object,Object,Object)} are passed to
   ...
   * paths. Values of non-constant arguments are not deterministic, and are null for most platforms. (Constant arguments
   * are arguments whose literal values are given to the UDF as opposed to non-constant arguments that are expressions
   * which depend on columns. For example, in the query {@code SELECT my_udf('my_value', T.Col1) FROM T}, {@literal
   * my_value} is a constant argument to the UDF and its value is the same for all invocations of this UDF, while {@code
   * T.Col1} is a non-constant argument since it is an expression that depends on a table column, and hence its value
